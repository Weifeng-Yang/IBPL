...
function [var,loss,timerun,bts,ats]=IPALM(var,ngmar,aa,maxiteropt,stopindex)
...
function var=IPALMupdate(vv,varze,var,varz,num,ngmar,aa,at,bt)
for j=1:num
V=gradipalm(vv,varz,var,at,bt,ngmar,j,num);
