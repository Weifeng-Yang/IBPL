...
elseif(flag==3) 
[vars,loss,tr,bts,ats]=IBPG(var,ngmar,aa,maxiteropt,stopindex,r);
varss=vars;
lossdata=loss;
trdata=tr;
btss=bts;
...
elseif(flag==4) 
[vars,loss,tr,bts]=TITAN(var,ngmar,aa,maxiteropt,stopindex,r);
varss=vars;
lossdata=loss;
trdata=tr;
btss=bts;
...
elseif(flag==5)
[vars,loss,tr,bts]=ABPL(var,ngmar,aa,maxiteropt,bt,2,stopindex,r,t,btmax); 
varss=vars;
lossdata=loss;
trdata=tr;
btss=bts;
...
elseif(flag==7) 
[vars,loss,tr,bts]=APGL(var,ngmar,aa,maxiteropt,stopindex,btmax,1);  
varss{1}=vars;
lossdata=loss;
trdata=tr;
btss=bts;
...
elseif(flag==10)
[vars,loss,tr,ats,bts]=IBPLtp(var,ngmar,aa,maxiteropt,at,bt,1,stopindex,r,t,btmax,rho); %%IBPL+-TP
varss=vars;
lossdata=loss;
trdata=tr;
btss=bts;
